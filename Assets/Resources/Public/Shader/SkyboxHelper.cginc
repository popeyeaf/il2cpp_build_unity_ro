...
#ifndef SKYBOX_HELPER_INCLUDED
#define SKYBOX_HELPER_INCLUDED
...
v2f vertProcedural (appdata_t v)
{
	v2f OUT;
	OUT.pos = UnityObjectToClipPos(v.vertex);
	OUT.texcoord = RotateAroundYInDegrees(v.vertex, _Rotation);
...
half4 fragProcedural (v2f IN) : SV_Target
{
