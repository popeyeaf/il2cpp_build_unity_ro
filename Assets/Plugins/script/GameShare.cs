...
#else
		private static void GameShare_RegisterExternalCallDelegate(IntPtr functionPointer){}
#endif
...
#else
		private static void GameShare_nativeSetListener(string gameName, string functionName){}
#endif
...
#else
		private static void GameShare_nativeShare(string info){}
#endif
...
#else
		private static bool GameShare_nativeIsFunctionSupported(string functionName)
		{
			return false;
		}
#endif
...
#else
		private static void GameShare_nativeSetDebugMode(bool bDebug){}
#endif
...
#else
		private static void GameShare_nativeGetPluginVersion(StringBuilder version){}
#endif
...
#else
		private static void GameShare_nativeGetSDKVersion(StringBuilder version){}
#endif
...
#else
		private static void GameShare_nativeCallFuncWithParam(string functionName, GameParam[] param,int count){}
#endif
...
#else
		private static int GameShare_nativeCallIntFuncWithParam(string functionName, GameParam[] param,int count)
		{
			return 0;
		}
#endif
...
#else
		private static float GameShare_nativeCallFloatFuncWithParam(string functionName, GameParam[] param,int count)
		{
			return 0;
		}
#endif
...
#else
		private static bool GameShare_nativeCallBoolFuncWithParam(string functionName, GameParam[] param,int count)
		{
			return false;
		}
#endif
...
#else
		private static void GameShare_nativeCallStringFuncWithParam(string functionName, GameParam[] param,int count,StringBuilder value){}
#endif
	}
