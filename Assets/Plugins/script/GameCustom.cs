...
#else
		private static void GameCustom_RegisterExternalCallDelegate(IntPtr functionPointer){}
#endif
...
#else
		private static void GameCustom_nativeSetListener(string gameName, string functionName){}
#endif
...
#else
		private static bool GameCustom_nativeIsFunctionSupported(string functionName)
		{
			return false;
		}
#endif
...
#else
		private static void GameCustom_nativeSetDebugMode(bool bDebug){}
#endif
...
#else
		private static void GameCustom_nativeGetPluginVersion(StringBuilder version){}
#endif
...
#else
		private static void GameCustom_nativeGetSDKVersion(StringBuilder version){}
#endif
...
#else
		private static void GameCustom_nativeCallFuncWithParam(string functionName, GameParam[] param,int count){}
#endif
...
#else
		private static int GameCustom_nativeCallIntFuncWithParam(string functionName, GameParam[] param,int count)
		{
			return 0;
		}
#endif
...
#else
		private static float GameCustom_nativeCallFloatFuncWithParam(string functionName, GameParam[] param,int count)
		{
			return 0;
		}
#endif
...
#else
		private static bool GameCustom_nativeCallBoolFuncWithParam(string functionName, GameParam[] param,int count)
		{
			return false;
		}
#endif
...
#else
		private static void GameCustom_nativeCallStringFuncWithParam(string functionName, GameParam[] param,int count,StringBuilder value){}
#endif
	}
