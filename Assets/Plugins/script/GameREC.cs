...
#else
		private static void GameREC_RegisterExternalCallDelegate(IntPtr functionPointer){}
#endif
...
#else
		private static void GameREC_nativeStartRecording(){}
#endif
...
#else
		private static void GameREC_nativeStopRecording(){}
#endif
...
#else
		private static void GameREC_nativeShare(string info){}
#endif
...
#else
		private static void GameREC_nativeSetListener(string gameName, string functionName){}
#endif
...
#else
		private static bool GameREC_nativeIsFunctionSupported(string functionName)
		{
			return false;
		}
#endif
...
#else
		private static void GameREC_nativeSetDebugMode(bool bDebug){}
#endif
...
#else
		private static void GameREC_nativeGetPluginVersion(StringBuilder version){}
#endif
...
#else
		private static void GameREC_nativeGetSDKVersion(StringBuilder version){}
#endif
...
#else
		private static void GameREC_nativeCallFuncWithParam(string functionName, GameParam[] param,int count){}
#endif
...
#else
		private static int GameREC_nativeCallIntFuncWithParam(string functionName, GameParam[] param,int count)
		{
			return 0;
		}
#endif
...
#else
		private static float GameREC_nativeCallFloatFuncWithParam(string functionName, GameParam[] param,int count)
		{
			return 0;
		}
#endif
...
#else
		private static bool GameREC_nativeCallBoolFuncWithParam(string functionName, GameParam[] param,int count)
		{
			return false;
		}
#endif
...
#else
		private static void GameREC_nativeCallStringFuncWithParam(string functionName, GameParam[] param,int count,StringBuilder value){}
#endif
	}
